...
class LRScheduler(lr_scheduler._LRScheduler):  # pylint: disable=W0212
    ...
    def get_lr(self) -> List[float]:
        ...
        warmup_ratio = step_count / self.warmup_steps
        cooldown_ratio = 1 - (step_count - self.cooldown_steps) / self.cooldown_steps
    ...
    def _get_lr(
        ...
        lr = self.method(progress) * (lr - final_lr) + final_lr
        ...
        if step_count > self.cooldown_steps_begin:
