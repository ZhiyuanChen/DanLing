...
def _einsum_bhk_bhlk_to_bhl(query_states, key_states):
    ...
    batch_idx, _ = key_states._packed_batch_local_indices(device=key_states._values.device)
...
def _einsum_bhl_bhlv_to_bhv(attention_probs, value_states):
    ...
    batch_idx, _ = attention_probs._packed_batch_local_indices(device=attention_probs._values.device)
