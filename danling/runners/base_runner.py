...
from danling.metrics import AverageMeter, AverageMeters, GlobalMetrics, StreamMetrics
...
class BaseRunner(metaclass=RunnerMeta):  # pylint: disable=too-many-public-methods
    ...
    See Also:
        [`Config`][danling.runners.Config]: Configuration for runners.

        [`RunnerMode`][danling.runners.utils.RunnerMode]: Enumeration of runner modes.
    ...
    train_metrics: GlobalMetrics | StreamMetrics | None = None
    evaluate_metrics: GlobalMetrics | StreamMetrics | None = None
