...
class MNISTRunner(dl.TorchRunner):
    def __init__(self, config: dl.RunnerConfig):
        ...
        self.datasets.train = torchvision.datasets.MNIST(train=True, transform=transform, **self.config.dataset)
        self.datasets.val = torchvision.datasets.MNIST(train=False, transform=transform, **self.config.dataset)
